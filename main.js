...
document.getElementById("light-mode").addEventListener("click", function () {
  if (isLightMode === false) {
    ...
    document.getElementById("accenture-btn").src = `/public/accenture-logo.svg`;
    document.getElementById("journey__img").src = `/public/accenture-logo.svg`;
    year.textContent = "2018";
    compDescription.innerHTML =
      "<strong>Accenture</strong> is a global professional services company that provides a wide range of services and solutions in strategy, consulting, digital, technology, and operations. The company helps organizations to improve their performance and create sustainable value for their stakeholders.";
    myDescription.innerHTML =
    ...
    document
      ...
      .addEventListener("click", function () {
        img.src = `/public/accenture-logo.svg`;
        year.textContent = "2018";
      });
  } else {
    isLightMode = false;
    ...
    allHeadings.forEach(function (heading) {
      heading.style.color = "#94a3b8"; // You can replace this with your desired color
    });
    document.getElementById("accenture-btn").src = `/public/acn-logo.png`;
    document.getElementById("journey__img").src = `/public/acn-logo.png`;
    year.textContent = "2018";
    compDescription.innerHTML =
      "<strong>Accenture</strong> is a global professional services company that provides a wide range of services and solutions in strategy, consulting, digital, technology, and operations. The company helps organizations to improve their performance and create sustainable value for their stakeholders.";
    myDescription.innerHTML =
